...
**Status Laravel:** ✅ Sudah diimplementasi di SalesService, StockInService, TransferService
...
- Simpan di `activeOpnameProvider`
- Tampilkan banner amber di semua screen transaksi
