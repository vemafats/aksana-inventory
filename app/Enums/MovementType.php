...
enum MovementType: string
{
    ...
    public function filamentBadgeLabel(): string
    {
        return match ($this) {
            self::STOCK_IN_AVAILABLE,
            self::STOCK_IN_DAMAGED => 'MASUK',
            self::TRANSFER_AVAILABLE => 'DISTRIBUSI',
            self::SALE => 'KELUAR',
            self::RETURN_TO_WAREHOUSE => 'RETUR',
            default => strtoupper($this->label()),
        };
    }
    ...
    public function filamentBadgeColor(): string
    {
        return match ($this) {
            self::STOCK_IN_AVAILABLE,
            self::STOCK_IN_DAMAGED => 'success',
            self::TRANSFER_AVAILABLE => 'info',
            self::SALE => 'danger',
            self::RETURN_TO_WAREHOUSE => 'warning',
            default => 'gray',
        };
    }

    public function qtyDisplayPrefix(): string
    {
        return match ($this) {
            self::SALE,
            self::STOCK_OPNAME_LOST,
            self::AVAILABLE_TO_DAMAGED,
            self::TRANSFER_AVAILABLE => '-',
            self::STOCK_IN_AVAILABLE,
            self::STOCK_IN_DAMAGED,
            self::STOCK_OPNAME_PLUS,
