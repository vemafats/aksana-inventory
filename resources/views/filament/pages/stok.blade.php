            ...
            <div style="padding:24px;">
                ...
                <div style="display:flex; gap:12px;">
                    <button @click="$wire.closePrintModal()" type="button"
                        style="flex:1; padding:14px; border:1px solid #d1d5db; border-radius:10px; background:white; cursor:pointer; font-weight:600; font-size:14px;">
                        Batal
                    </button>
                    <button @click="printLabel()" type="button" x-bind:disabled="!selectedBarcode || printing"
                        style="flex:1; padding:14px; border:none; border-radius:10px; color:white; font-weight:600; font-size:14px; cursor:pointer;"
                        x-bind:style="!selectedBarcode || printing ? 'background:#9ca3af; cursor:not-allowed;' : 'background:#1a1a2e;'">
