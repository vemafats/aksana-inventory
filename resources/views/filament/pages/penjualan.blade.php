<x-filament-panels::page>
    ...
    @if ($activeTab === 'ringkasan')
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4 mb-6">
            @foreach ([
                ['label' => 'Penjualan Hari Ini', 'value' => \App\Filament\Pages\PenjualanPage::formatRupiah($stats['today_sales']), 'sub' => 'hari ini'],
                ['label' => 'Penjualan 7 Hari', 'value' => \App\Filament\Pages\PenjualanPage::formatRupiah($stats['seven_day_sales']), 'sub' => '7 hari terakhir'],
                ['label' => 'Item Terjual (24H)', 'value' => number_format($stats['items_sold_24h']), 'sub' => 'unit terjual'],
                ['label' => 'Rata-rata Nota', 'value' => \App\Filament\Pages\PenjualanPage::formatRupiah($stats['avg_basket']), 'sub' => 'per transaksi hari ini'],
            ] as $card)
                <div class="aksana-stat-panel">
                    <p class="aksana-stat-label">{{ $card['label'] }}</p>
                    <p class="aksana-stat-value">{{ $card['value'] }}</p>
