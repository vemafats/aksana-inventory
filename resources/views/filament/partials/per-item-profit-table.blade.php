        ...
        <table style="width:100%; border-collapse:collapse; font-size:13px;">
            <thead>
                <tr style="border-bottom:2px solid #e5e7eb;">
                    ...
                    <th style="text-align:right; padding:10px 12px; font-weight:600; font-size:11px; text-transform:uppercase; letter-spacing:0.5px; color:#6b7280;">Penjualan</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f3f4f6;">
                    ...
                    <td style="padding:10px 12px; text-align:right; font-family:'IBM Plex Mono',monospace;">{{ \App\Helpers\FormatHelper::price($item->total_revenue) }}</td>
