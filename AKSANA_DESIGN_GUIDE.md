...
BUKAN harga modal — ini informasi publik yang bisa dilihat Admin.
Harga modal tetap terlindungi dengan password (sesuai keputusan sebelumnya).
Role akses: Owner, Admin.
